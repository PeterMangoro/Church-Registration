<template>
 <div class="mb-2">
        <div class="p-6 bg-white border rounded shadow-xl w-72">
          <div class="flex mb-2">
          ...
          <span class="flex space-x-2">
            ...
            class="flex items-center px-4 py-2 text-sm font-medium text-white bg-red-500 rounded-md hover:bg-red-600">
                <p>Empty Trash</p>
                <tooltip
                 class="ml-1"
                  :tip=more_tip
